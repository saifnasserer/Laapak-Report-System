...
class LpkHeader {
    constructor(options = {}) {
        ...
        this.options = {
            navigationItems: options.navigationItems || [
                ...
                { text: 'إنشاء فاتورة', url: 'create-invoice.html', icon: 'fas fa-file-invoice', id: 'create-invoice' },
    ...
    generateHeaderHTML() {
        ...
        let html = `
        <nav class="navbar navbar-dark header-navbar" style="background: linear-gradient(135deg, #0d964e 0%, #0a572b 100%); box-shadow: 0 8px 32px rgba(0,0,0,0.15); border-radius: 16px; position: relative; overflow: hidden;">
            ...
            <div class="container py-3">
                <div class="d-flex justify-content-between align-items-center w-100">
                    ...
                    <ul class="navbar-nav d-flex flex-row flex-nowrap align-items-center justify-content-center" style="gap: 0.75rem; position: relative; z-index: 2;">`;
