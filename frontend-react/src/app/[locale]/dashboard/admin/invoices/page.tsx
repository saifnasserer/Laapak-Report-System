...
import { Receipt, Search, Plus, Download, Printer, Filter } from 'lucide-react';
            ...
            <div className="space-y-10">
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <Button variant="outline" size="md" className="w-11 h-11 p-0 rounded-xl bg-white border-black/10" title="تصدير">
                            <Download size={18} />
                        </Button>
                        <Button
                            size="md"
